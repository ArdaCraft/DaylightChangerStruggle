        ...
        if (this.menuElements.containsKey(this.currentMenu)) {
            ...
            switch (this.currentMenu) {
                case MAIN_MENU: {
                    ...
                    elements.add(ButtonWidget.builder(Text.empty(), btn -> {
                    }).build());
        ...
        if (this.currentMenu == Menu.SWITCH_DAYLIGHT_CYCLE_MENU) {
            ...
            while (e.hasNext()) {
                ...
                if (elem instanceof SwitchGetterBasisBuilderList l && l.isVisible()) {
                    if (keys) {
                        if (elem.isFocused()) {
                            l.renderTooltipsFromKey(ctx, mouseX, mouseY);
                            break;
                        }
                    } else if (elem.isMouseOver(mouseX, mouseY)) {
                        l.renderTooltipsFromMouse(ctx, mouseX, mouseY);
                        break;
                    }
                }
            }
    ...
    private class SwitchDaylightCycleBuilderListEntry extends SwitchGetterBasisBuilderEntry<SwitchDaylightCycleBuilderListEntry> {
        ...
        public void render(DrawContext ctx, int mouseX, int mouseY, boolean hovered, float deltaTicks) {
            ...
            if (hovered) {
                ...
                colorEnd = 0xFF00AADD;
                colorTextName = 0xFF000000;
                colorTextDesc = 0xFFBB2222;
            } else if (this.onEdit) {
